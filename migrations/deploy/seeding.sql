...
INSERT INTO "visit" ("title","dateStart","dateEnd","comment", "note","geo","place_id","trip_id") VALUES
('Paris','2022-05-20', '2024-05-27', 'Visite de la tour Eiffel',4,'x', 1, 1),
('Paris','2023-06-18','2023-06-25','Visite du musée du Louvre', 5,'x', 1, 1),
('Paris','2020-07-08','2020-07-15','Promenade sur les Champs-Elysées', 3,'x', 1, 1),
('Lyon','2021-06-10', '2024-06-17', 'Visite du vieux Lyon', 5,'x', 2, 2),
('Nice','2022-07-15', '2024-07-22', 'Promenade sur la promenade des anglais', 3,'x', 3, 3),
('Marseille','2022-08-20', '2024-08-27', 'Découverte du vieux port', 4,'x', 4, 4),
('Bordeaux','2021-09-10', '2024-09-17', 'Visite des vignobles bordelais', 5,'x', 5, 5),
('Lille','2022-01-20', '2025-01-27', 'Balade dans le vieux Lille', 4,'x', 9, 3),
('Rennes','2022-02-15', '2025-02-22', 'Découverte du parc du Thabor', 3,'x', 10, 1);
